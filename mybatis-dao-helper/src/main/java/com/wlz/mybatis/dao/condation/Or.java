 ...
 * 
 */
public class Or extends Condation {
	...
	protected Or(ICondation condation, RawSql rawSql) {
		this.condation = condation;
		this.rawSql = rawSql;
	}
	
	protected Or(ICondation condation,String name, String op, Object value) {
		this.condation = condation;
		this.name = name;
		this.op = op;
		this.value = value;
	...
	protected Or(ICondation condation, Segment segment) {
		this.condation = condation;
